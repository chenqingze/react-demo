module.exports = {
  ...
  'rules': {
    ...
    'perfectionist/sort-imports': [1, {
      ...
      'groups': [['builtin', 'external'], 'custom-mui', 'custom-routes', 'custom-hooks', 'custom-utils', 'internal', 'custom-components', 'custom-sections', 'custom-types', ['parent', 'sibling', 'index'], 'object', 'unknown'],
      'custom-groups': {
        'value': {
          'custom-mui': '@mui/**',
